...
local plugins = {
	...
	},
	{
		...
		config = delegate("treesitter-context"),
	},
	...
	{ "rcarriga/nvim-notify" },
	{
		...
		config = delegate("noice"),
	},
	{ "nvimdev/dashboard-nvim", dependencies = { "nvim-tree/nvim-web-devicons" }, config = delegate("dashboard") },
	-- LSP Support
	{
